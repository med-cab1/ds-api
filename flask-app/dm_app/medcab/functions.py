"""Hardcoded dict to return disease and prescriptions"""
...
def disease_filter(disease):
    ...
    'Muscle_Spasms': 'Daily Dosage: 20-25mg THC. Divide doses (in capsule form) over the day.',
    'Autism': 'Daily Dosage: 2.5mg-10mg CBD. Start with low dose of oral solution, and increase over time.',
    'Sleep_Apnia': 'Daily Dosage: 2.5-10mg THC.	Take 1 capsule at bedtime.',
    ...
    'Intractable_Pain':	'Daily Dosage: 15-27mg THC/CBD. Spray 6-10 times per day.',
